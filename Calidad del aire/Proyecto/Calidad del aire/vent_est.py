...
#     ventana3.title('Anรกlisis de datos en todas las estaciones')
...
#     titulo = ttk.Label(frame_derecho, text="Use la lista desplegable para seleccionar el cรณdigo de la estaciรณn para la cual desea conocer los valores diarios promedio para los contaminantes medidos. " \
#     "Use los botones Mostrar el grรกfico y Datos correspondientes, en el menรบ desplegable para ver el grรกfico o los datos para la estaciรณn seleccionada.",
...
#     boton_menu = ttk.Button(ventana3, text="Menรบ", command=toggle_menu)
#     boton_menu.place(x=10, y=10)

#     texto_cancelar = ttk.Label(
#         frame_derecho,
#         text="Para salir de esta ventana, presione el botรณn Cancelar en el menรบ desplegable.",
...
#     titulo = ttk.Label(frame_derecho, text=u"Use la lista desplegable para seleccionar el código de la estación para la cual desea conocer los valores diarios promedio para los contaminantes medidos. " \
...
#         raise ValueError("No hay estaciones válidas en el dataframe 'coordenadas'.") 
...
#     boton_menu = ttk.Button(ventana3, text=u"Menú", command=toggle_menu) 
#     boton_menu.place(x=10, y=10) 
